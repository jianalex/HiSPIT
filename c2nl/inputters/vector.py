...
def vectorize(ex, model):
    ...
    vectorized_ex['code_struc_code_rep'] = None
    ...
    if code.struc is not None:
        ...
        vectorized_ex['code_struc_code_rep'] =  torch.as_tensor(code.struc_code , dtype=torch.long)
...
def batchify(batch):
    ...
    code_struc_code = [ex['code_struc_code_rep'] for ex in batch]
    ...
    code_struc_code_rep = torch.zeros(batch_size, max_code_len, max_code_len, dtype=torch.long) \
        if use_code_struc else None
    ...
    for i in range(batch_size):
        ...
        if use_code_struc:
            ...
            code_struc_code_rep[i, :, :].copy_(code_struc_code[i][:max_code_len, :max_code_len])
    ...
    return {
        ...
        'code_struc_code_rep' : code_struc_code_rep
    }
