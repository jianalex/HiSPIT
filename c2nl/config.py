...
def add_model_args(parser):
    ...
    data.add_argument('--code_tag_type', type=str, default='subtoken',
                      help='Use code type as additional feature for feature representations')
      # FOR PDG
    data.add_argument('--max_pdg_nodes', type=int, default=64,
                      help='Maximum allowed numbers for nodes of per PDG')
    data.add_argument('--max_pdg_tokens', type=int, default=64,
                      help='Maximum allowed numbers for tokens in the node of PDG')
    data.add_argument('--token_emsize', type=int, default=64,
                      help='Embedding size of tokens in the node and edge of PDG')
