...
class Code2NaturalLanguage(object):
    ...
    def update(self, ex):
        ...
        code_struc_code_rep = ex['code_struc_code_rep']
        ...
        if self.use_cuda:
            ...
            if code_struc_rep is not None:
                ...
                code_struc_code_rep = code_struc_code_rep.cuda(non_blocking=True)
        ...
        net_loss = self.network(code_word_rep=code_word_rep,
                                ...
                                code_struc_rep=code_struc_rep, # for code structure 
