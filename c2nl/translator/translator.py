...
class Translator(object):
    ...
    def translate_batch(self, batch_inputs):
        ...
        code_struc_code_rep = batch_inputs['code_struc_code_rep']
        ...
        if model_name == 'Transformer':
            memory_bank, layer_wise_outputs = encoder(code_rep, 
                                                    code_len, 
            ...
            src_lens = memory_len.repeat(beam_size)
        ...
        if model_name == 'Transformer' and model.layer_wise_attn:
            ...
            memory_bank_copy = memory_bank[:, :code_rep.size(1),:] #for pdg
            ...
            if model_name == 'Transformer':
                ...
                if self.copy_attn:
                    _, copy_score, _ = model.copy_attn(dec_out,
                                                       memory_bank_copy, # fpr pdg #memory_bank,
